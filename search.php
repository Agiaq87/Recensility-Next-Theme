...
<h1 class="recensility-posts-heading white"><span><i class="fas fa-search-location"></i> Risultati della ricerca<?php  //echo('Risultati per: ' . get_search_query()); ?></span></h1>
</header>
